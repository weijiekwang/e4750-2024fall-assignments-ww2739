...
if __name__ == "__main__":
    ...
    iteration_indexes = np.arange(1, 51)
    ...
    for current_operation in valid_operations:
        ...
        for vector_size in valid_vector_sizes_initial:
            ...
            print("Operation:", current_operation, "| Vector Length:", vector_size)
        ...
        plt.loglog(vector_sizes_plot, arr_avg_total_device_time, label='DeviceAdd')
        plt.loglog(vector_sizes_plot, arr_avg_total_buffer_time, label='BufferAdd')
    ...
    # Determine the slower CPU method
    # Assuming 'CPU Loop Add' is slower, we exclude it
